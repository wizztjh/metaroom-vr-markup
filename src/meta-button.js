class MetaButtonController extends MRM.MetaComponentController {
  constructor(dom){
    super(dom)
    this.setupComponent();
  ...
  createMetaObject(){
    ...
    var button = new PushButton(
      new InteractablePlane(mesh, Leap.loopController),
      {
        ...
        //TODO: write code to rotate the object (metaObject.mesh.rotate.z)
...
class MetaButton extends MRM.MetaComponent {
  createdCallback() {
    this.controller = new MetaButtonController(this);
    super.createdCallback();
  }
}

document.registerElement('meta-button', MetaButton);
